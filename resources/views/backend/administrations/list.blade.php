                                    ...
                                    <tbody>
                                        @foreach ($users as $key => $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->income()->sum('amount') }}</td>
                                                <td>{{ $item->expenses()->sum('amount') }}</td>
                                                <td>
                                                ...
                                                <td class="center-align">
                                                    <a href="#modalDelete" onclick="setRoute('{{ $item }}', '{{ route('admin.administration.destroy', $item) }}')" class="modal-trigger btn-floating red pulse"><i class="material-icons">delete</i></a>
                                                </td>
                                        </tr>
                                    @endforeach
                                </tbody>
