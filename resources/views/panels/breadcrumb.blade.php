    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s2 m6 l6">
                @if(isset($addNewBtn))
                <a href="{{ route($addNewBtn) }}" class="btn waves-effect waves-light breadcrumbs-btn right">
        ...
        <div class="row">
            ...
            <div class="col s2 m6 l6"><a
                ...
                <ul class="dropdown-content" id="dropdown1" tabindex="0">
                    <li tabindex="0"><a class="grey-text text-darken-2" href="{{ route('admin.profile') }}">Profile<span
                    ...
                    <li tabindex="0"><a class="grey-text text-darken-2" href="{{ route('admin.logout') }}">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
