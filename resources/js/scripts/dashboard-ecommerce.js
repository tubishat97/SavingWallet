...
(function (window, document, $) {
    ...
    var LineSL2ctx = document
        .getElementById(
            "custom-line-chart-sample-two"
        )
        .getContext("2d");

    var gradientStroke = LineSL2ctx.createLinearGradient(
        500,
        0,
        0,
        200
    ...
    var gradientFill = LineSL2ctx.createLinearGradient(
        500,
        0,
        0,
        200
    ...
    var LineSL3ctx = document
        .getElementById(
            "custom-line-chart-sample-three"
        )
        .getContext("2d");

    var gradientStroke = LineSL3ctx.createLinearGradient(
        500,
        0,
        0,
        200
    ...
    var gradientFill = LineSL3ctx.createLinearGradient(
        500,
        0,
        0,
        200
